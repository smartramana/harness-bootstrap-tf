...
locals {
  ...
  docker_connectors = { for name, details in var.harness_platform_docker_connectors : name => details if details.enable }
  aws_connectors    = { for name, details in var.harness_platform_docker_connectors : name => details if details.enable }
